...
<html lang="en">
  ...
  <body>
    <section class="container" data-aos="flip-up"  data-aos-duration="2000">>
      <div class="column">
      <header>Outstation Driver</header>
      </div>
        ...
        <div class="column">
          <div class="radio-button-box">
            ...
            <div class="radio-button-option">
              <div class="radio">
                <input type="radio" id="round_trip" name="Trip_type"/>
...
<?php
  if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `outstation_form` (`vehicle_transmission`, `address`, `pickup_loc`, `visit_loc`, `drop_loc`, `date`, `time`, `car_type`, `duty_hrs`) VALUES ('$vehicle_trans', '$address', '$pickup', '$visit', '$drop', '$date', '$time', '$car_type', '$duty_hrs');";
