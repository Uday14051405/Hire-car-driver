...
<?php
  if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `night_form` (`vehicle_transmission`, `address`, `pickup_loc`, `visit_loc`, `drop_loc`, `date`, `time`, `car_type`, `duty_hrs`) VALUES ('$vehicle_trans', '$address', '$pickup', '$visit', '$drop', '$date', '$time', '$car_type', '$duty_hrs');";
